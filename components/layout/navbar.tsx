...
export function Navbar({ onToggleSidebar, isSidebarOpen }: NavbarProps) {
    ...
    return (
        <header className="sticky top-0 z-40 w-full h-16 border-b border-primary/10 bg-background/80 backdrop-blur-md flex items-center justify-between px-4 lg:px-6">
